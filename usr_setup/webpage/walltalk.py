...
import random
import time
from walltalk import walltalk

current_dir = os.path.dirname(os.path.abspath(__file__))


class Demowalltalk(object):

    def __init__(self):
        self.title = None
        self.txt = None
        self.img = None
        self.ui = walltalk(img_dir=os.path.join(current_dir, 'imgs'))
        self.src = "sunset.png"
    ...
    def main_menu(self):
        self.page = self.ui.new_ui_page(title="walltalk")
        self.list = self.page.add_list()
